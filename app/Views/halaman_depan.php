...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?= base_url('image/undira.png'); ?>">
  <link rel="icon" type="image/png" href="<?= base_url('image/undira.png'); ?>">
  <title>
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="<?= base_url('login/auth'); ?>">
                    ...
                    <br>
                    <input type="submit" class="btn btn-danger col-md-12" value="Login" style="display: block; width: 100%; padding: 10px;"> -->
                  </form>
                  <!-- <form > -->
            ...
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('<?php echo base_url('./image/gedungundira.jpg'); ?>');
